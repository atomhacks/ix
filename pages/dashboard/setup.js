              ...
              <div className="space-y-4">
                ...
                <div className="space-y-4 md:text-sm">
                  ...
                  <p>
                    ...
                    something they have never thought of before. It will be a creative outlet for people to plug
                    themselves in and start creating!
                  </p>

                  <p>
                    NO PRIOR KNOWLEDGE NEEDED. If you don&apos;t know how to code, it&apos;s no problem at all. We
                    welcome you to come and learn through our amazing workshops. We have prizes for beginner coders, so
                    come on down and create something with your friends, have fun, and take home a grand prize. There
                    will also be swag and free lunch and dinner for everyone participating!
                  </p>

                  <p>
                    The event will take place March 18th from 8 AM to 8 PM at BRONX SCIENCE. You will be able to present
                    to a panel of awesome judges for a chance to win PRIZES! Team up with your friends and learn how to
                    make amazing things! There will be workshops and guest speakers as well so make sure to sign up!
                  </p>

                  <p>
                    Please check atomhacks.org for more information about the schedule and FAQs. If you have any
                    questions email atomhacks@bxscience.edu.
                  </p>
                </div>
              </div>
