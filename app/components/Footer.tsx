    ...
    <div>
      <footer className="bg-neutral-900 text-center text-white dark:bg-neutral-900">
        <div className="flex flex-row pt-6 pb-6 font-montserrat text-neutral-200">
          ...
          <div className="m-auto flex basis-1/4 flex-row">
            <a href="https://www.instagram.com/bxsciatomhacks/">
              <Image
                className="h-18 md:h-50 md:w-50 md hydrated m-auto w-16 basis-1/3 px-2 text-3xl duration-300 hover:text-gray-500"
                src={InstagramIcon}
                alt="Instagram"
              />
            </a>
            <a href="https://github.com/atomhacks">
              <Image
                className="h-18 md:h-50 md:w-50 md hydrated m-auto w-16 basis-1/3 px-2 text-3xl duration-300 hover:opacity-40"
                src={GithubIcon}
                alt="GitHub"
              />
            </a>
            <a href="mailto:atomhacks@bxscience.edu">
              <EnvelopeIcon className="h-18 md:h-50 md:w-50 md hydrated m-auto w-16 basis-1/3 px-2 text-3xl duration-300 hover:text-gray-500" />
            </a>
          </div>
        </div>
      </footer>
