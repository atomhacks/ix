/*
  ...
  - The values [SPONSOR_PENDING] on the enum `Track` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Track_new" AS ENUM ('GENERAL', 'BEGINNER', 'TASKADE');
